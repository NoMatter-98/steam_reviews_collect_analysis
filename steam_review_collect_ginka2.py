...
# --- Configuration ---
APP_ID = 2536840  # Black Myth: Wukong
OUTPUT_CSV_FILE = "GINKA_steam_reviews_all.csv"
MAX_REVIEWS_TO_FETCH = 3000 # Set to an integer to limit for testing, or None for all
...
while True:
    ...
    try:
        ...
        print(f"Network or HTTP error: {e}. Retrying in {REQUEST_DELAY_SECONDS*5} seconds...")
        time.sleep(REQUEST_DELAY_SECONDS * 5) # Longer wait on error
